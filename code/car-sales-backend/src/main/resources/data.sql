...
SELECT * FROM (
  ...
  UNION ALL
  SELECT '哈弗', 'H6', '1.5T', '7档双离合', '白色', 119800.00, 5, 'on_sale', '2026-06-15 08:00:00', '/images/12.jpg'
  UNION ALL
  SELECT '蔚来', 'ET5', '纯电动', '单速变速箱', '粉色', 298000.00, 2, 'on_sale', '2026-06-20 08:00:00', '/images/13.jpg'
  UNION ALL
  SELECT '小鹏', 'P7', '纯电动', '单速变速箱', '银色', 239900.00, 3, 'on_sale', '2026-06-20 08:00:00', '/images/14.jpg'
  UNION ALL
  SELECT '理想', 'L7', '增程式', '单速变速箱', '灰色', 319800.00, 2, 'on_sale', '2026-06-20 08:00:00', '/images/15.jpg'
  UNION ALL
  SELECT '福特', '蒙迪欧', '2.0T', '8档手自一体', '蓝色', 199800.00, 4, 'on_sale', '2026-06-20 08:00:00', '/images/16.jpg'
  UNION ALL
  ...
  UNION ALL
  SELECT '日产', '天籁', '2.0L', 'CVT无级变速', '红色', 179800.00, 5, 'on_sale', '2026-06-25 08:00:00', '/images/19.jpg'
  UNION ALL
...
SELECT * FROM (
  ...
  UNION ALL
  SELECT 6, 12, '2026-08-03 09:00:00', 'confirmed', '2026-07-27 08:00:00', '2026-07-28 10:00:00', '管理员', '哈弗H6白色'
  UNION ALL
